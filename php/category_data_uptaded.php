<?php
	...
	/*== Almacenando id ==*/
    $id=limpiar_strings($_POST['categoria_id']);
    ...
    /*== Almacenando datos ==*/
    $nombre=limpiar_strings($_POST['categoria_nombre']);
    ...
    /*== Verificando nombre ==*/
    if($nombre!=$datos['cat_nombre']){
	    $check_nombre=conexion();
	    $check_nombre=$check_nombre->query("SELECT cat_nombre FROM categoria WHERE cat_nombre='$nombre'");
    ...
    $actualizar_categoria=$actualizar_categoria->prepare("UPDATE categoria SET cat_nombre=:nombre,cat_ubicacion=:ubicacion WHERE categoria_id=:id");
