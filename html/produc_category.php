            ...
            <?php
                ...
                if($categorias->rowCount()>0){
                    ...
                    foreach($categorias as $row){
                        echo '<a href="index.php?vista=produc_category&category_id='.$row['categoria_id'].'" class="button is-link is-inverted is-fullwidth">'.$row['cat_nombre'].'</a>';
                    }
                }else{
        ...
        <div class="column">
            <?php
                ...
                if($check_categoria->rowCount()>0){
                    ...
                    echo '
                        <h2 class="title has-text-centered">'.$check_categoria['cat_nombre'].'</h2>
                        <p class="has-text-centered pb-6" >'.$check_categoria['cat_ubicacion'].'</p>
                    ';
                    ...
                    $page=limpiar_strings($pagina);
                    $url="index.php?vista=produc_category&category_id=$categoria_id&page="; /* <== */
                    $registros=5;
                    $busqueda="";
